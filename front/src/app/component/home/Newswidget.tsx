...
export default function NewsWidget({id,title,date}:prop) {
    ...
    return (
        <div key={id} className="card bg-[#2C353D] shadow-xl w-full font-Poppins">
            <div className="card-body">
                ...
                <div className="card-actions justify-end text-primary-500 hover:text-primary-600">
                    <button className="flex flex-row justify-center items-center gap-4 font-bold"><p>ข้อมูลเพิ่มเติม</p> <Icon icon="majesticons:arrow-right" /></button>
                </div>
            </div>
        </div>
